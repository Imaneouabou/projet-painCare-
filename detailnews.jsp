           ...
           <div class="col-xl-7 col-lg-8 col-md-10 ">
            <div class="hero-wrapper">
             <div class="hero__caption">
               <h1 data-animation="fadeInUp" data-delay=".3s">Detail Of :</h1>
               <p data-animation="fadeInUp" data-delay=".6s">Title<br> of the new</p>
             </div>
           </div>
         </div>
       </div>
  ...
  <div class="row">
   <div class="col-lg-8 posts-list">
    ...
    <div class="blog_details">
      <h2 style="color: #2d2d2d;"> Title of the news
     </h2>
     <ul class="blog-info-link mt-3 mb-4">
       <li><a href="#"><i class="fa fa-user"></i> User_writer</a></li>
       <li><a href="#"><i class="fa fa-comments"></i>Number of comments</a></li>
     </ul>
     <p class="excert">
       Description of the new
       should have to spend money on boot camp when you can get the MCSE study materials yourself at
        a fraction of the camp pricld have to spend money on boot camp when you can get the MCSE study materials yourself at
        a fraction of the camp pric
     </p>    
 </div>
</div>
...
<aside class="single_sidebar_widget popular_post_widget">
  <h3 class="widget_title" style="color: #2d2d2d;">Recent Articles</h3>
